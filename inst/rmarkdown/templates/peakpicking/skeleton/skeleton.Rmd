...
mzrt3 <- enviGCMS:::getdata(path,pmethod = 'hplchqtof')
mzrt3 <- enviGCMS::getmzrt(mzrt3)
```
...
re <- getcompare(mzrt,mzrt2,mzrt3)
...
library(venn)
venn::venn(compare,snames = c('ipo','autotuner','default'))
