...
cwp <- CentWaveParam(snthresh = 10, prefilter = c(3, 4000), ppm = 10,
...
# using hmdb local db
data("hmdb5")
has_mz <- containsMz(hmdb5, mz = unique(std_spectra$precursorMz)[order(unique(std_spectra$precursorMz))], ppm = 10)
hmdb2 <- hmdb5[has_mz]
spectra_match <- matchSpectra(
    std_spectra, hmdb2,
    param = CompareSpectraParam(ppm = 10, requirePrecursor = FALSE))
spectra_match
```
