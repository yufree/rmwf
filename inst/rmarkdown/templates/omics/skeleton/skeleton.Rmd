...
This analysis is used to compute correlation between two dataset. In this case, it's different omics dataset. Such analysis could connect two datasets by latent variable from Canonical Correlation Analysis.
